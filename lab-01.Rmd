...
NA - Not available
This is because some of the data in n_2021 is not avaiable and if any of the data is NA, then a mean or median cannot be calculated
...
There are some attractions with a very high number of visitors, bringing up the mean values.
...
visitors %>%
  summarise(
  percentage_change = 100*n_2022/n_2021
  )
